...
<main class="app-content">
  <div class="app-title">
    <ul class="app-breadcrumb breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="#">Thêm banner</a></li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        ...
        <div class="tile-body">
          ...
          <?php } ?>
          <form action="./?mod=banner&act=store" method="POST" role="form" enctype="multipart/form-data" class="row">
            <div class="form-group col-md-12">
              <label class="control-label">Tên banner</label>
              <input class="form-control" name="TenBN" type="text">
            </div>
            <div class="form-group col-md-12">
            ...
            <div class="form-group col-md-12">
              ...
              <textarea class="form-control" name="MoTaBN" id="mota"></textarea>
              <script>
