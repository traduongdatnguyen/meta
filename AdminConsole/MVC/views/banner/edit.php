...
<main class="app-content">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        <h3 class="tile-title">Chỉnh sửa banner banner</h3>
        ...
        <div class="tile-body">
          ...
          <?php } ?>
          <form action="./?mod=banner&act=update" method="POST" role="form" enctype="multipart/form-data" class="row">
            <div class="form-group">
              <input class="form-control" value="<?= $data['Id'] ?>" name="id" type="hidden">
            </div>
            <div class="form-group col-md-12">
              <label class="control-label">Tên banner</label>
              <input class="form-control" value="<?= $data['TenBN'] ?>" type="text">
            </div>
            ...
            <div class="form-group col-md-6">
              ...
              <div id="myfileupload">
                <img src="../public/assets/images/banners/<?= $data['HinhAnh'] ?>" width="500">
              </div>
            </div>
            <div class="form-group col-md-12">
              <label class="control-label">Mô tả</label>
              <textarea class="form-control" name="MoTaBN" id="mota"><?= $data['MoTaBN'] ?></textarea>
              <script>
            ...
            <div class="form-group col-md-12">
              ...
              <a class="btn btn-cancel" href="banner">Hủy bỏ</a>
            </div>
