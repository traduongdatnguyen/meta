                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if (isset($_SESSION['isLogin_Admin']) && $_SESSION['isLogin_Admin'] == true) { ?>
                                            <a href="./?mod=danhmuc&act=edit&id=<?= $data['MaDM'] ?>" class="btn btn-warning">Update</a>
                                            <a href="./?mod=danhmuc&act=delete&id=<?= $data['MaDM'] ?>" onclick="return confirm('Do you really want to delete?');" type="button" class="btn btn-danger">Delete</a>
                                        <?php } ?>
                                    </td>
                                </tr>
                        </tbody>
