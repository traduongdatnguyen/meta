    ...
    <div class="col-md-12">
      ...
      <div class="tile">
        ...
        <div class="tile-body">
          ...
          <form action="?mod=qlnhanvien&act=update" method="POST" role="form" enctype="multipart/form-data" class="row">
            ...
            <div class="form-group col-md-4">
              <label class="control-label">Ảnh 3x4 nhân viên</label>
              <img width="100%" src="../public/assets/images/testimonials/<?= $data['HinhAnh'] ?>" alt="">
            </div>
