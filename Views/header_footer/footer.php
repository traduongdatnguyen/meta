<footer class="footer">
    <div class="cta bg-image bg-dark pt-4 pb-5 mb-0" style="background-image: url(public/assets/images/demos/demo-4/bg-5.jpg);">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-3">
                    <div class="widget widget-about">
                        <img src="public/assets/images/logo.png" class="footer-logo" alt="Footer Logo" width="105" height="25">
    ...
    <div class="footer-bottom">
        <div class="container">
            <p class="footer-copyright">Copyright © 2021 Meta Store. All Rights Reserved.</p>
