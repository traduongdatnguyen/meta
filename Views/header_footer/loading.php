                                    ...
                                    <form action="login" id="form1" method="post" role="form">
                                        <?php if (isset($_COOKIE['msg1'])) { ?>
                                            <div class="alert alert-success">
                                                <strong>Notify:</strong> <?= $_COOKIE['msg1'] ?>
                                            </div>
                                        <?php } ?>
                                        <div class="form-group">
                                            <label for="singin-email">Username or email address *</label>
                                            <input type="text" class="form-control" id="singin-email" name="taikhoan" required>
                                        </div><!-- End .form-group -->

                                        <div class="form-group">
                                            <label for="singin-password">Password *</label>
                                            <input type="password" class="form-control" id="singin-password" name="matkhau">
                                        </div><!-- End .form-group -->
