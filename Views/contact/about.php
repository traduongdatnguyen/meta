...
<head>
    ...
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="public/assets/images/icon-logo.webp">
    <link rel="icon" type="image/png" sizes="32x32" href="public/assets/images/icon-logo.webp">
    <link rel="icon" type="image/png" sizes="16x16" href="public/assets/images/icon-logo.webp">
    <link rel="manifest" href="public/assets/images/icon-logo.webp">
    <link rel="mask-icon" href="public/assets/images/icon-logo.webp" color="#666666">
    <link rel="shortcut icon" href="public/assets/images/icon-logo.webp">
    <meta name="apple-mobile-web-app-title" content="Meta">
    <meta name="application-name" content="Meta">
    <meta name="msapplication-TileColor" content="#cc9966">
    <meta name="msapplication-config" content="public/assets/images/icon-logo.webp">
...
<body>
    <div class="page-wrapper">
            ...
            <div class="header-middle sticky-header">
                <div class="container">
                    <div class="header-left">
                        ...
                        <a href="." class="logo">
                            <img src="public/assets/images/meta.png" alt="Meta Logo" width="105" height="25">
                        </a>
                        ...
                        <div class="header-search">
                            ...
                            <form action="./?act=shop" method="POST">
                                <div class="header-search-wrapper">
                                    <button type="submit" for="q" class="sr-only">Search</button>
                                    <input type="search" class="form-control" name="keyword" id="q" placeholder="Search in..." required>
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <div class="dropdown-cart-products">
                                    <div class="product">
                                        ...
                                        <figure class="product-image-container">
                                            <a href="product.html" class="product-image">
                                                <img src="public/assets/images/products/cart/product-1.jpg" alt="product">
                                            </a>
                                        </figure>
                                        <a href="#" class="btn-remove" title="Remove Product"><i class="icon-close"></i></a>
                                    </div><!-- End .product -->
                                    ...
                                    <div class="product">
                                        ...
                                        <figure class="product-image-container">
                                            <a href="product.html" class="product-image">
                                                <img src="public/assets/images/products/cart/product-2.jpg" alt="product">
                                            </a>
                                        </figure>
                                        <a href="#" class="btn-remove" title="Remove Product"><i class="icon-close"></i></a>
                                    </div><!-- End .product -->
        ...
        <main class="main">
            ...
            <div class="container">
                <div class="page-header page-header-big text-center" style="background-image: url('public/assets/images/about-header-bg.jpg')">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-5 mb-3 mb-lg-0">
                                ...
                                <a href="blogs" class="btn btn-sm btn-minwidth btn-outline-primary-2">
        ...
        <footer class="footer">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-3">
                            <div class="widget widget-about">
                                <img src="public/assets/images/meta.png" class="footer-logo" alt="Footer Logo" width="105" height="25">
            ...
            <div class="footer-bottom">
                <div class="container">
                    <p class="footer-copyright">Copyright © 2021 Meta Store. All Rights Reserved.</p><!-- End .footer-copyright -->
