                ...
                <form action="?act=checkout&xuli=save" method="POST">
                    <div class="row">
                        <div class="col-lg-9">
                            ...
                            <input type="text" name="NguoiNhan" class="form-control" placeholder="<?= $_SESSION['login']['Ho'] ?> <?= $_SESSION['login']['Ten'] ?>" required>


                            <div class="row">
                                <div class="col-sm-6">
                                    <label>Town / City *</label>
                                    <input type="text" name="DiaChi" class="form-control" placeholder="<?= $_SESSION['login']['DiaChi'] ?>" required>
                                </div><!-- End .col-sm-6 -->

                                <div class="col-sm-6">
                                    <label>State / County *</label>
                                    <input type="text" name="Quan" class="form-control" placeholder="<?= $_SESSION['login']['Quan'] ?>" required>
                                </div><!-- End .col-sm-6 -->
                            </div><!-- End .row -->
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="Phuong" class="form-control" placeholder="<?= $_SESSION['login']['Phuong'] ?>" required>
                                </div>
                                <div class="col-sm-6">
                                    <label>Phone *</label>
                                    <input type="tel" name="SDT" class="form-control" placeholder="<?= $_SESSION['login']['SDT'] ?>" required>
                                </div><!-- End .col-sm-6 -->
                            </div><!-- End .row -->

                            <label>Email address *</label>
                            <input type="email" name="Email" class="form-control" placeholder="<?= $_SESSION['login']['Email'] ?>" required>
                                ...
                                <table class="table table-summary">
                                    <?php if (isset($_SESSION['products'])) {
                                        foreach ($_SESSION['products'] as $value) { ?>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><a href="#">Color/Quality</a></td>
                                                    <td><?= $value['Color'] ?>/<?= $value['SoLuong'] ?></td>
                                                </tr>
                                            </tbody>
                                    <?php   }
                                    } ?>
                                ...
                                <div class="accordion-summary" id="accordion-payment">
                                    <div class="card">
                                        <div class="card-header" id="heading-1">
                                            <h2 class="card-title">
                                                <input type="radio" name="PhuongThucTT" value="Direct bank transfer" role="button" data-toggle="collapse" href="#collapse-1" aria-expanded="true" aria-controls="collapse-1">
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="heading-2">
                                            <h2 class="card-title">
                                                <input type="radio" value="Check payments" name="PhuongThucTT" class="collapsed" role="button" data-toggle="collapse" href="#collapse-2" aria-expanded="false" aria-controls="collapse-2">
                                                Check payments
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="heading-5">
                                            <h2 class="card-title">
                                                <input type="radio" name="PhuongThucTT" value=" Credit Card (Stripe)" class="collapsed" role="button" data-toggle="collapse" href="#collapse-5" aria-expanded="false" aria-controls="collapse-5">
                                                Credit Card (Stripe)
